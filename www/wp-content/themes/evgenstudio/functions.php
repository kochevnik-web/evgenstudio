...
if ( defined( 'JETPACK__VERSION' ) ) {
	...
	add_action( 'wp_footer', 'yandex_google_counters' );
	function yandex_google_counters() {
		?>
			...
			<noscript><div><img src="https://mc.yandex.ru/watch/7665814" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
			<!-- /Yandex.Metrika counter -->

			<!-- Global site tag (gtag.js) - Google Analytics -->
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-40515785-1"></script>
			<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', 'UA-40515785-1');
			</script>
		<?php
	}
